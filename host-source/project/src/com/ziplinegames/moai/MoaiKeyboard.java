...
public class MoaiKeyboard {
	...
	private static String mKeyStringPrev = new String();
	...
	public static void update () {
		...
		synchronized ( Moai.sAkuLock ) 
		{
			...
			if (!mTextIsReady)
				mTextIsReady = !mKeyStringPrev.equals(mKeyString);
			if ( mTextIsReady ) {
				mKeyStringPrev = mKeyString;
				AKUNotifyTextDone();
				mTextIsReady = false;
			}
		}
	...
	public static void showKeyboard () {	
		...
		mKeyInTextView.requestFocus();
		mInputMethodManager.showSoftInput ( mKeyInTextView, 0 );	
		mKeyStringPrev = mKeyInTextView.getText().toString();
		mKeyString = mKeyStringPrev;
	}
	public static boolean tryHideKeyboard () {	
		mKeyInTextView.setText ( "" );
