...
// Based on Android-15 Source Code Version (from Android-SDK release) of GLSurfaceView med små lokale ændringer
 ...
 * </pre>
 */
public class CDSCGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
     ...
     */
    public CDSCGLSurfaceView(Context context) {
        super(context);
     ...
     * {@link #setRenderer} to register a renderer.
     */
    public CDSCGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initializeGlEsVersion(context);
        init();
    }
...
//    }
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link CDSCGLSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
...
//    }
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link CDSCGLSurfaceView#setEGLConfigChooser(EGLConfigChooser)}
     */
