...
//		setContentView(R.layout.otherpay);
		setContentView(R.layout.newotherpay);
...
//			return;
		...
		int color1=getResources().getColor(R.color.yellowtxtcolor);
		s11.setSpan(new ForegroundColorSpan(color1), 5, s1.length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);	
		name.setText(s11);
...
//		Intent intent1= new Intent(SelectActivity.this, ChongZhiActivity.class);
		Intent intent1= new Intent(SelectActivity.this, NewChongZhiActivity.class);
