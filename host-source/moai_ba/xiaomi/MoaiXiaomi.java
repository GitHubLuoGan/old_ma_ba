...
//是否退出时执行
    ...
    { 
     ...
     //   Bundle mBundle = new Bundle();
        mBundle.putString( GameInfoField.GAME_USER_BALANCE, userinfoJson.get("money").toString());  //用户余额
        mBundle.putString( GameInfoField.GAME_USER_GAMER_VIP, Vip_level);  //vip 等级  登陆
        mBundle.putString( GameInfoField.GAME_USER_LV, userinfoJson.get("lv").toString());          //角色等级  
    ...
    public String SetCharInfo(JsonValue parms){
        ...
        Vip_level = jsonData.get("vipLevel").toString();
