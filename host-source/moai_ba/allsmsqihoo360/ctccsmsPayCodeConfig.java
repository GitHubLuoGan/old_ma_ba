...
public class ctccsmsPayCodeConfig {
	public static List<ctccsmsPayCodeConfig> pCodeList=null;
	...
	public String number; 
	 ...
	 public static void setPayCodeConfig(){
	        ...
	        if(billingMap!=null){
	            pCodeList=new ArrayList<ctccsmsPayCodeConfig>();         
	 ...
	 ///
	 public static ctccsmsPayCodeConfig getPayCodeConfig(ctccsmsPayCodeConfig bconfig){
