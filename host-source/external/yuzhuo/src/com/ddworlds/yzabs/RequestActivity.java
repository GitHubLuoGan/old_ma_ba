...
//		RequestDialog.requestDialogShow(RequestActivity.this, "付费请求已发出，请耐心等待...");
		...
		String _paramId="1000";//正式是1000测试是2000  
		...
		_paramId="9000";//渠道商编号：  5000
		//第一个参数就是产品编号 和 渠道编号相同    //仙魔杀产品编号：5000
		String str=_paramId+"&fid="+price+"&cid="+_paramId+"&CpOrderID="+cporderid+"&CpUserID="+cpuserid+"&CpOrderDesc="+cpdesc;//cid渠道号
		//String str=_paramId+"&fid="+fid_str+"&cid="+_paramId+"&CpOrderID="+cporderid+"&CpUserID="+cpuserid+"&CpOrderDesc="+cpdesc;//cid渠道号
		Log.v("myTag", "支付实际参数："+str);
