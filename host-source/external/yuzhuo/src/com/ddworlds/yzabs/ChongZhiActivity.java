...
//		bankCardNumAddSpace(card2); 
		...
		czbackbtn=(ImageButton) findViewById(R.id.czbtnback);
		czbackbtn.setOnClickListener(l1);  
		
		cztip1=(TextView) findViewById(R.id.cztip1);//应付金额提示
		String _txt1= "本次支付金额为"+pro.price+"元";//cztip1.getText().toString();
	...
	OnClickListener l1= new OnClickListener(){
		...
		public void onClick(View v) {
			...
			if(id==R.id.czbtnback){
				...
				AlertDialog ad =new AlertDialog.Builder(ChongZhiActivity.this).setTitle("请选择卡类型")
...
//			   areaRadioListView=ad.getListView();
			   ad.show();
				...
				new AlertDialog.Builder(ChongZhiActivity.this).setTitle("请选择卡面额").setItems(info2[_index],new DialogInterface.OnClickListener(){
			      public void onClick(DialogInterface dialog, int which){
			       ...
			       if (Params.tip_debug){
			    	   Toast.makeText(ChongZhiActivity.this, "您已经选择了: " + which + ":" + info2[_index][which],Toast.LENGTH_LONG).show();
			       }
				...
				if(_table1[1].equals("1")){//可以支付
					if (Params.tip_debug){
						Toast.makeText(ChongZhiActivity.this, "可以支付购买",Toast.LENGTH_LONG).show();
					}
					System.out.println("result before");
					RequestDialog.requestDialogShow(ChongZhiActivity.this, "正在提交充值请求，请耐心等待...");
...
//									Activity1.AbsListener1.callBack(0,_s);//扣费失败
					...
					Toast.makeText(ChongZhiActivity.this, _t1[0],Toast.LENGTH_LONG).show();
				}
			}
	...
	Handler mhandler=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			if (id==R.id.cz_type){
				...
				String _text=info2[radioOnClick.getIndex()][number];
...
//				MyDialog.dialog1(Activity3.context, _tip, 3, 0);
  ...
  class RadioOnClick implements DialogInterface.OnClickListener{
	  ...
	  public void onClick(DialogInterface dialog, int whichButton){
	    ...
	    if (Params.tip_debug){
	    	Toast.makeText(ChongZhiActivity.this, "您已经选择了： " + index + ":" + info1[index], Toast.LENGTH_LONG).show();
	    }
	    dialog.dismiss();
