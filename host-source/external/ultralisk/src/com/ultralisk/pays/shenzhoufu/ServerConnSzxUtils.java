...
public class ServerConnSzxUtils {
     ...
     * @return 进行des加密，并进行base64的字符串
     */
    public static String getDesEncryptBase64String(int cardType,String cardMoney, String cardSn, String cardPwd, String desKey) {
        System.out.println("DES String:"+cardType+"@"+ cardMoney + "@" + cardSn + "@" + cardPwd);
        //String desString = DesEncrypt.getEncString(cardMoney + "@" + cardSn + "@" + cardPwd, desKey, "UTF8");
        String desString;
        try {
