...
public class mmsmsPayCodeConfig {
	public static List<mmsmsPayCodeConfig> pCodeList=null;
	...
	public String number; 
	 public static void setPayCodeConfig(){
	        ...
	        if(billingMap!=null){
	            pCodeList=new ArrayList<mmsmsPayCodeConfig>();         
	 ...
	 ///
	 public static mmsmsPayCodeConfig getPayCodeConfig(mmsmsPayCodeConfig bconfig){
